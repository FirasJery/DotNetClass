...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231108163019_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtisteFestival", b =>
                {
                    b.Property<int>("ArtistesArtisteId")
                        .HasColumnType("int");

                    b.Property<int>("FestivalsFestivalId")
                        .HasColumnType("int");

                    b.HasKey("ArtistesArtisteId", "FestivalsFestivalId");

                    b.HasIndex("FestivalsFestivalId");

                    b.ToTable("ArtisteFestival");
                });
            ...
            modelBuilder.Entity("ArtisteFestival", b =>
                {
                    b.HasOne("ApplicationCore.Domain.Artiste", null)
                        .WithMany()
                        .HasForeignKey("ArtistesArtisteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Domain.Festival", null)
                        .WithMany()
                        .HasForeignKey("FestivalsFestivalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
